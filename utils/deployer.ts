...
export async function deployAll() {
  ...
  return { usdt, kakiToken, wbnbToken, kakiUsdtLp, kakiBnbLP, chainlink, game, openBox, ticket, allowClaimTicket: allowList, kakiTicket, garden, kakiCaptain, captainClaim, noLoss, mysteryBox};
}
